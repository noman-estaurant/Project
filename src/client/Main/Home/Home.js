  ...
  render() {
    ...
    return (
      <div class="main_body">
        ...
        <div class="index" id="app">
          {
            this.state.Data.map((data, index) => {
              return (
                <div class="namecard">
                  <img src="src/ClipMap.jpg" alt="" class="clip_map" id="No.1" onClick={() => initDirection(index, data.lat, data.lng)}/>
                  <div class="info">
                    <div class="storedata">
        ...
        <Tabbar />
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDccWrnP-3yQ0h_SXABCLSKpYK8yfrIBbc&callback=initMap"async defer></script>
      </div>
    )
  }
}
